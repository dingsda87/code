...
class GenericDomainObject implements GenericORMapperDataObject {
   ...
   /**
    * Convenience method to retrieve the creation timestamp of an object.
    *
    * @return string The creation timestamp with scheme <em>YYYY-mm-dd HH:ii:ss</em>.
    *
    * @author Christian Achatz
    * @version
    * Version 0.1, 03.07.2014<br />
    */
    ...
    *
    * @return string The modification timestamp with scheme <em>YYYY-mm-dd HH:ii:ss</em>.
    *
    * @author Christian Achatz
    * @version
    * Version 0.1, 03.07.2014<br />
